...
export const metadata = {
  ...
  description:
    'Learn about Pearloria — our story, mission, and the values that drive our business compliance and registration services in Nigeria.',
};
...
const values = [
  {
    emoji: '💡',
    title: 'Clarity',
    desc: 'We explain processes clearly, avoiding unnecessary jargon so clients understand every step of the way.',
  },
  {
    emoji: '🔍',
    title: 'Transparency',
    desc: 'No hidden fees, no misleading promises — just honest guidance and clear expectations from start to finish.',
  },
  {
    emoji: '✅',
    title: 'Compliance',
    desc: 'We prioritize accuracy and adherence to regulatory requirements, ensuring every registration meets legal standards.',
  },
  {
    emoji: '🤝',
    title: 'Professionalism',
    desc: 'Every client is handled with respect, confidentiality, and meticulous attention to detail.',
  },
];

const whyUs = [
  { label: 'Expertise in CAC pre & post incorporation services' },
  { label: 'Strong focus on compliance and long-term business stability' },
  { label: 'Client-first advisory approach' },
  { label: 'Reliable documentation and timely filings' },
  { label: 'Support beyond registration' },
];
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  Rather than simply filing documents, Pearloria was built to educate, guide, and properly structure businesses from the very beginning — and support them as they grow. Today, Pearloria supports startups, growing businesses, NGOs, and established organizations with reliable registration, compliance, and advisory services.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div className="grid grid-cols-1 gap-5">
              {[
                ...
                <div key={i} className="bg-emerald-50 rounded-2xl p-6 border border-emerald-100 flex items-center gap-5">
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 mb-10 text-lg">
            Choosing Pearloria means choosing professionalism, clarity, and long-term support. Start your business journey the right way.
          </p>
