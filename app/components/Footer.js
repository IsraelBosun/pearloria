...
const serviceLinks = [
  { label: 'Business Name Registration', href: '/services#business-name' },
  { label: 'LTD Registration', href: '/services#ltd' },
  { label: 'NGO / Inc. Trustees', href: '/services#ngo' },
  { label: 'Trademark & Copyright', href: '/services#trademark' },
  { label: 'Annual Returns Filing', href: '/services#annual-returns' },
  { label: 'TIN & SCUML Registration', href: '/services#tin' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-5">
              ...
              <span className="text-xl font-bold text-white">Pearloria</span>
            </Link>
            <p className="text-sm leading-relaxed max-w-sm mb-6">
              Refining business ideas into legally structured, protected, and valuable entities. Nigeria's trusted business compliance and registration brand.
            </p>
