...
import { FadeUp, FadeIn, HeroAnimate, StaggerContainer, StaggerItem } from '../components/animations';

export const metadata = {
  title: 'Services — Pearloria',
  description: 'Explore all Pearloria services: Business Name, LTD, NGO registration, trademark, TIN, SCUML, annual returns, and business advisory in Nigeria.',
};

function ServiceCard({ id, emoji, title, what, who, why, cta = 'Get Started', ctaHref = 'https://wa.me/2347072613455', external = true }) {
  return (
    <div id={id} className="bg-white rounded-2xl border border-gray-100 p-8 hover:shadow-lg transition-shadow scroll-mt-20 flex flex-col h-full">
      ...
      {external ? (
        <a
          ...
          className="inline-flex items-center gap-2 bg-emerald-600 text-white text-sm font-bold px-5 py-2.5 rounded-lg hover:bg-emerald-700 transition-colors self-start"
        >
          {cta}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
          ...
          <section id="registration" className="scroll-mt-28">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  id: 'business-name', emoji: '🏢', title: 'Business Name Registration',
                ...
                {
                  id: 'ltd', emoji: '⚖️', title: 'Limited Liability Company (LTD) Registration',
                ...
                {
                  id: 'upgrade', emoji: '⬆️', title: 'Business Name Upgrade to LTD',
                ...
                {
                  id: 'ngo', emoji: '🤝', title: 'NGO / Incorporated Trustees Registration',
                  what: 'Registration of NGOs, churches, associations, and foundations as Incorporated Trustees with CAC.',
                ...
                <StaggerItem key={card.id} className="flex">
                  <ServiceCard {...card} />
                </StaggerItem>
              ))}
            </StaggerContainer>
          ...
          <section id="compliance" className="scroll-mt-28">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  id: 'annual-returns', emoji: '📋', title: 'Filing of Annual Returns',
                ...
                {
                  id: 'scuml', emoji: '🏦', title: 'SCUML Registration',
                ...
                {
                  id: 'tin', emoji: '🔢', title: 'All Types of TIN Registration',
          ...
          <section id="ip" className="scroll-mt-28">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                {
                  id: 'trademark', emoji: '™️', title: 'Trademark Registration',
                ...
                {
                  id: 'copyright', emoji: '©️', title: 'Copyright & Patent Registration',
          ...
          <section id="advisory" className="scroll-mt-28">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  id: 'structure-advisory', emoji: '🗺️', title: 'Business Structure Advisory',
                  ...
                  cta: 'Book Consultation', ctaHref: '/contact', external: false,
                },
                {
                  id: 'pre-registration', emoji: '🔎', title: 'Pre-Registration Guidance',
                ...
                {
                  id: 'compliance-review', emoji: '📊', title: 'Compliance Reviews',
      ...
      <section className="py-20 bg-emerald-600">
        <FadeIn>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-extrabold text-white mb-4">Ready to Register or Stay Compliant?</h2>
            <p className="text-emerald-100 text-lg mb-8">Let Pearloria handle the process while you focus on growing your business.</p>
